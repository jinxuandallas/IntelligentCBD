...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 1200px;">
        ...
        <tr>
            <td style="width: 900px; height: 524px;"><img alt="" src="../Images/青岛中央商务区鸟瞰2b.jpg" style="width:800px"/></td>
            <td style="text-align:right; height: 524px;vertical-align:central">
