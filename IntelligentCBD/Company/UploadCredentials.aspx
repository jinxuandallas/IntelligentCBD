...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 550px" class="MainTable">
        <tr>
            <td class="TableTitle" style="width:100px">上传证照</td>
                ...
                <table class="TableBox">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td colspan="2">
                                    <div class="divpic" id="divpic" runat="server" style="vertical-align: middle; writing-mode: vertical-lr; margin: 10px">
