    ...
    <table style="width: 900px;">
        ...
        <tr>
            <td colspan="4">
                    ...
                    <ItemTemplate>
                        ...
                        <div style="padding: 10px; margin: 10px; border: solid; border-width: 1px; border-color: black;width:700px;height:120px">
                            <div style="float:left;width:150px;height:100px; margin: 10px">
                                <asp:Image ID="Image企业宣传图片" ImageUrl='<%#t.TransformPicAddress( Eval("图片地址").ToString()) %>'  Width="150px" Height="100px" runat="server" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [企业名称], [注册资本], [载体名称], [图片地址], [ID] FROM [企业视图]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
